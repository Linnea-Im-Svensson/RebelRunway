  ...
  return (
    <>
      ...
      <div
        ...
        } left-0 top-0 h-screen w-screen bg-black bg-opacity-30 transition-all`}
        onClick={(e) => (
      ...
      <div
        className={`fixed bottom-0 flex h-screen w-screen translate-x-0 flex-col justify-between bg-yellow-50  sm:w-96 ${
          showSideModal
            ? position === "right"
              ? "right-0"
              : "left-0"
      ...
      >
        ...
        {position === "left" && (
          <div>
            <Link
              href="/profile"
              className=" flex w-full items-center gap-4 border-b-2 border-yellow-300 bg-yellow-200 p-2 text-left text-xl"
            >
              <FaRegUserCircle />
              Profile
            </Link>
            <button
              ...
              className="mt-auto flex w-full items-center gap-4  bg-yellow-200 p-2 text-left text-xl"
            >
              <BsArrowReturnRight />
      ...
      {position === "left" && (
        <div
          ...
          } z-30 flex h-screen w-screen translate-x-0 flex-col justify-between bg-yellow-50  transition-all  sm:w-96`}
        >
          <div className="flex justify-center p-2">
            {position === "left" && <Logo />}
          </div>
