...
const SidebarNavModal = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-0 flex h-screen w-screen translate-x-0 flex-col justify-between bg-yellow-50  dark:bg-slate-800 dark:text-slate-100 sm:w-96 ${
          showSideModal
            ? position === "right"
              ? "right-0"
              : "left-0"
        ...
        {position === "left" && (
          <div>
            ...
            <button
              ...
              className="mt-auto flex w-full items-center gap-4  bg-yellow-200 p-2 text-left text-xl dark:border-slate-800 dark:bg-slate-900"
            >
              <BsArrowReturnRight />
